    ...
    <div class="container">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="kdMatpel" placeholder="Masukkan KD Matpel">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Matpel</label>
                <input type="text" class="form-control" name="namaMatpel" placeholder="Masukkan Nama Matpel">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Jam</label>
                <input type="number" class="form-control" name="jumlahJam" placeholder="Masukkan Jumlah Jam">
            </div>
            <div class="mb-3">
